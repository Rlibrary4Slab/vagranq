        ...
        return {
                    ...
                    if (linkChildren.count() == 1) {
                        ...
                        if (childTag.type == CKEDITOR.NODE_ELEMENT) {
                            if (childTag.is('img') || childTag.is('input')) {
                                ...
                                else if (this.imageElement.is('input')) this.imageEditMode = 'input';
                            }
                        }
                    }
                    // Fill out all fields.
            ...
            contents: [{
                ...
                elements: [{
                    ...
                    commit: function(type, element) {
                        if (type == IMAGE) {
                            if (this.getValue() || this.isChanged()) element.setAttribute('alt', this.getValue());
                        } else if (type == PREVIEW) element.setAttribute('alt', this.getValue());
                        else if (type == CLEANUP) {
                    ...
                    children: [{
                            ...
                            children: [{
                                ...
                                children: [{
                                    ...
                                    validate: function() {
                                        ...
                                        if (!isValid) //alert(editor.lang.common.invalidWidth); // jshint ignore:line
                                        return isValid;
                                    },
                                    ...
                                    commit: function(type, element) {
                                        var value = this.getValue();
                                        if (type == IMAGE) {
                                            if (value && editor.activeFilter.check('img{width,height}')) element.setStyle('width', CKEDITOR.tools.cssLength(value));
                                            ...
                                            if (!aMatch) {
                                                ...
                                                if (oImageOriginal.getCustomData('isReady') == 'true') element.setStyle('width', oImageOriginal.$.width + 'px');
                                            } else {
                                    ...
                                    validate: function() {
                                        var aMatch = this.getValue().match(regexGetSizeOrEmpty),
                                            isValid = !! (aMatch && parseInt(aMatch[1], 10) !== 0);
                                        if (!isValid) //alert(editor.lang.common.invalidHeight); // jshint ignore:line
                                        return isValid;
                                    },
                                    setup: setupDimension,
                                    commit: function(type, element) {
                                        var value = this.getValue();
                                        if (type == IMAGE) {
                                            if (value && editor.activeFilter.check('img{width,height}')) element.setStyle('height', CKEDITOR.tools.cssLength(value));
                                            ...
                                            if (!aMatch) {
                                                var oImageOriginal = this.getDialog().originalElement;
                                                if (oImageOriginal.getCustomData('isReady') == 'true') element.setStyle('height', oImageOriginal.$.height + 'px');
                                            } else {
                            ...
                            children: [{
                                ...
                                commit: function(type, element) {
                                    ...
                                    if (type == IMAGE || type == PREVIEW) {
                                        ...
                                        if (type == IMAGE) element.removeAttribute('border');
                                    } else if (type == CLEANUP) {
                                ...
                                commit: function(type, element) {
                                    ...
                                    if (type == IMAGE || type == PREVIEW) {
                                        ...
                                        if (type == IMAGE) element.removeAttribute('hspace');
                                    } else if (type == CLEANUP) {
                                ...
                                commit: function(type, element) {
                                    ...
                                    if (type == IMAGE || type == PREVIEW) {
                                        ...
                                        if (type == IMAGE) element.removeAttribute('vspace');
                                    } else if (type == CLEANUP) {
                        ...
                        children: [{
                            ...
                            (editor.config.image_previewText || 'ｆ') +
                ...
                elements: [{
                    ...
                    setup: function(type, element) {
                        if (type == LINK) this.setValue(element.getAttribute('target') || '');
                    },
                    commit: function(type, element) {
                        if (type == LINK) {
                            if (this.getValue() || this.isChanged()) element.setAttribute('target', this.getValue());
                        }
                    }
                }]
            }, {
                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        setup: function(type, element) {
                            if (type == IMAGE) this.setValue(element.getAttribute('id'));
                        },
                        commit: function(type, element) {
                            if (type == IMAGE) {
                                if (this.getValue() || this.isChanged()) element.setAttribute('id', this.getValue());
                            }
                        }
                    }, {
                        id: 'cmbLangDir',
                        ...
                        setup: function(type, element) {
                            if (type == IMAGE) this.setValue(element.getAttribute('dir'));
                        },
                        commit: function(type, element) {
                            if (type == IMAGE) {
                                if (this.getValue() || this.isChanged()) element.setAttribute('dir', this.getValue());
                            }
                        }
                    }, {
                        type: 'text',
                        ...
                        'default': '',
                        setup: function(type, element) {
                            if (type == IMAGE) this.setValue(element.getAttribute('lang'));
                        },
                        commit: function(type, element) {
                            if (type == IMAGE) {
                                if (this.getValue() || this.isChanged()) element.setAttribute('lang', this.getValue());
                            }
                        }
                    }]
                }, {
                    ...
                    setup: function(type, element) {
                        if (type == IMAGE) this.setValue(element.getAttribute('longDesc'));
                    },
                    commit: function(type, element) {
                        if (type == IMAGE) {
                            if (this.getValue() || this.isChanged()) element.setAttribute('longDesc', this.getValue());
                        }
                    }
                }, {
                    type: 'hbox',
                    ...
                    children: [{
                        ...
                        'default': '',
                        setup: function(type, element) {
                            if (type == IMAGE) this.setValue(element.getAttribute('class'));
                        },
                        commit: function(type, element) {
                            if (type == IMAGE) {
                                if (this.getValue() || this.isChanged()) element.setAttribute('class', this.getValue());
                            }
                        }
                    }, {
                        type: 'text',
                        ...
                        setup: function(type, element) {
                            if (type == IMAGE) this.setValue(element.getAttribute('title'));
                        },
                        commit: function(type, element) {
                            if (type == IMAGE) {
                                if (this.getValue() || this.isChanged()) element.setAttribute('title', this.getValue());
                            } else if (type == PREVIEW) element.setAttribute('title', this.getValue());
                            else if (type == CLEANUP) {
                    ...
                    setup: function(type, element) {
                        if (type == IMAGE) {
                            ...
                            if (!genStyle && element.$.style.cssText) genStyle = element.$.style.cssText;
                    ...
                    onChange: function() {
                        ...
                        this, ['info:cmbFloat', 'info:cmbAlign', 'info:txtVSpace', 'info:txtHSpace', 'info:txtBorder', 'info:txtWidth', 'info:txtHeight']);
                        updatePreview(this);
                    },
                    commit: function(type, element) {
                        if (type == IMAGE && (this.getValue() || this.isChanged())) element.setAttribute('style', this.getValue());

module Notifications
    ...
    def notification_savesend( articled, content, category, eyecatch_img)                   #いいね/閲覧の通知履歴を残して新着を飛ばす。
        ...
        send = {category: category, article_title: articled.title, content: content, notification_counts: notification_counts, flag: false, eyecatch_img: eyecatch_img, article_url: "http://ranq-media.com/articles/#{articled.id}", user_url: "http://ranq-media.com/#{articled.user.user_name}/edit_articles"}

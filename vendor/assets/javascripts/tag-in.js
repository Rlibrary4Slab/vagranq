...
(function($) {
    ...
    TagComponent.prototype = {
        ...
        domRemove: function(item) {
            ...
            if (this.options.animate) {
                // animate removal
                item.el1.fadeOut('fast').hide('blind', {
                    direction: 'horizontal'
                }, 'fast', removeFn).dequeue();
            } else {
                removeFn();
            }
        },
        ...
        tags: function(val, tagInput, options) {
            if (val === undefined) { // getter
                return $.map(this.items.slice(1), function(x) {
                    return x.tag();
                });
    ...
    TagInput.prototype = {
        ...
        domCreate: function() {
            ...
            tagElement.append(tagLabel);
            tagElement.append(removeTag);
            ...
            if (this.component.options.accessor === 'val') {
                ...
                this.inputElement = $('<div>', {
                    ...
                    'class': 'ui-widget-content content-input'
                });
            }
        ...
        onChange: function(event, explicit) {
            ...
            if (this.component.options.allowedChars instanceof RegExp) {
                ...
                if (event.type && event.type === 'keypress' && printable(event) && !String.fromCharCode(event.which).match(this.component.options.allowedChars)) {
                    event.preventDefault();
                }
            ...
            if (this.component.options.delimiterCreateTag && this.component.options.allowNewTags) {

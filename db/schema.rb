...
ActiveRecord::Schema.define(version: 20180228073346) do
  ...
  create_table "item_spots", force: :cascade do |t|
    t.integer  "item_id",    limit: 4
  ...
  create_table "news_crawlers", force: :cascade do |t|
    t.string   "title",      limit: 255
    t.text     "news_link",  limit: 65535
    t.text     "news_body",  limit: 65535
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
    t.text     "news_image", limit: 65535
    t.integer  "article_id", limit: 4
  end
  ...
  create_table "news_tags", force: :cascade do |t|
    ...
    t.text     "article_description", limit: 65535
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer  "writer_status",          limit: 4

                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            commit: function(a, b) {
                                1 == a && (this.getValue() || this.isChanged()) ? (b.data("cke-saved-src", this.getValue()), b.setAttribute("src", this.getValue()),b.setAttribute("title",this.getValue())) : 8 == a && (b.setAttribute("src", ""), b.removeAttribute("src"))
                            },
